...
class HMIWindow(Gtk.Window):
    ...
    def initModbus(self):
        ...
        self.modbusClient = ModbusClient(MODBUS_SERVER_IP, port=MODBUS_SERVER_PORT)
    ...
    def __init__(self):
        Gtk.Window.__init__(self, title="IO ICS\SCADA - HMI")
        ...
        virtuaPlant.set_markup("<span size='small'>HMI</span>")
